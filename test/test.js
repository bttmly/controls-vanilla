...
(function() {
  ...
  test("Value", function() {
    ...
    equal(JSON.stringify(values.keyValue()), JSON.stringify({
      "mixedCheck": "check",
      "mixedText": "text",
      "mixedSelect": "option3"
    }), ".keyValue() looks good");
  ...
  test("Valid", function() {
    var allowed, allowedFalse, alphanumeric, alphanumericFalse, email, emailFalse, isValue, isValueFalse, lengthBetween, lengthBetweenFalse, lengthIs, lengthIsFalse, lengthMax, lengthMaxFalse, lengthMin, lengthMinFalse, letters, lettersFalse, list, listFalse, notAllowed, notAllowedFalse, notEmpty, notEmptyFalse, notEmptyTrim, notEmptyTrimFalse, numberBetween, numberBetweenFalse, numberMax, numberMaxFalse, numberMin, numberMinFalse, numeric, numericFalse, phone, phoneFalse;
    ...
    return equal(Controls.validate(lengthIsFalse), false, "'lengthIs' validation false as expected");
  });
