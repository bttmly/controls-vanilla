...
(function() {
  var $_, ControlCollection, Factory, changedEvent, controlValidations, each, elClear, elValid, elValue, every, filter, invalidEvent, isFunction, map, p, partial, slice, validEvent,
  ...
  controlValidations = (function() {
    ...
    v = {
      ...
      checkbox: function(el, minChecked, maxChecked) {
        ...
        if ((name = el.name)) {
          len = $_("input[type='radio'][name='" + name + "']").filter(function(input) {
            return input.checked;
          });
