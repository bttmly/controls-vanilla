...
(function() {
  var $_, ControlCollection, Factory, changeEvent, controlValidations, each, elClear, elValid, elValue, event, every, extend, filter, invalidEvent, isFunction, map, p, slice, trigger, validEvent,
