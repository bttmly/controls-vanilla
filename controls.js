...
(function() {
  var ControlCollection, Factory, changedEvent, controlValidations, each, elClear, elValid, elValue, filter, isFunction, map, p, partial, slice, validEvent,
  ...
  ControlCollection = (function(_super) {
    ...
    ControlCollection.prototype.invoke = function() {
      var args, control, fn, _i, _len, _results;
      fn = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      _results = [];
      for (_i = 0, _len = this.length; _i < _len; _i++) {
        control = this[_i];
        if (fn in control && isFunction(control[fn])) {
          _results.push(control[fn](args));
        } else {
