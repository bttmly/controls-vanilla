...
(function() {
  var $_, ControlCollection, Factory, changedEvent, controlValidations, each, elClear, elValid, elValue, every, extend, filter, invalidEvent, isFunction, map, p, remove, slice, validEvent,
  ...
  ControlCollection = (function(_super) {
    ...
    ControlCollection.prototype.off = function(eventType, handler) {
      ...
      listeners = this._eventListeners[eventType] || [];
      return remove(listeners, handler);
    };
